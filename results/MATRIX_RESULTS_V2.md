...
96/192 cells. 4 tool-capable models x 12 multifault OTel windows x 2 methods x 2 conditions. Fixed code: plain truly plain; structured has svc/sev/trace tags + the errors_by_service digest. Cell = accuracy, mean tokens, mean sub-calls, abort%.
